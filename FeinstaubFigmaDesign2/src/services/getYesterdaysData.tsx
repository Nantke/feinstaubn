const getYesterdaysData = async () => {
    ...
    try {
        const response = await fetch(("https://www.umweltbundesamt.de/api/air_data/v3/measures/json?date_from="+getFormattedDates().thedaybeforeyesterdayISO+"&date_to="+getFormattedDates().yesterdayISO+"&station=DENI016&lang=de"),
            {
                method:'GET',
                headers: {
