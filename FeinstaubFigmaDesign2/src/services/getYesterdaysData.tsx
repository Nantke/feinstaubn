const getYesterdaysData = async () => {
    ...
    try {
        const response = await fetch(("/api/umwelt/air_data/v3/measures/json?date_from="+getFormattedDates().thedaybeforeyesterdayISO+"&date_to="+getFormattedDates().yesterdayISO+"&station=DENI016&lang=de"),
            {
                method:'GET',
                headers: {
